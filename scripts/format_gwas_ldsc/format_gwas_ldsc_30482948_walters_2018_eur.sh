...
# sample size: ............................  "N" ..................  None .................. (11,569 + 34,999)
...
zcat $path_source_file | awk 'BEGIN { FS=" "; OFS=" " } NR > 1 {split($2,a,":"); print a[1], toupper($4), toupper($5), (11569 + 34999), $6, $7}' >> $path_gwas_collection
