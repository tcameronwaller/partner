...
# sample size: ............................  "N" ..................  None .................. (10,206 + 28,480)
...
zcat $path_source_file | awk 'BEGIN { FS=" "; OFS=" " } NR > 1 {split($2,a,":"); print a[1], toupper($4), toupper($5), (10206 + 28480), $6, $7}' >> $path_gwas_collection
