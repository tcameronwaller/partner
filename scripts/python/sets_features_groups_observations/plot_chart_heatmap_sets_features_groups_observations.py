...
def plot_heatmap_features_labels_observations_groups(
    ...
    # Create figure.
    figure = splot.plot_heatmap_signal_features_labels_observations_groups(
...
def plot_heatmap_features_sets_observations_groups(
    ...
    colors = pplot.define_color_properties()
    # Create figure.
    figure = splot.plot_heatmap_signal_features_sets_observations_groups(
        table_signal=table_signal,
...
def plot_heatmap_features_sets_observations_labels(
    ...
    colors = pplot.define_color_properties()
    # Create figure.
    figure = splot.plot_heatmap_signal_features_sets_observations_labels(
        table_signal=table_signal,
        table_feature_sets=table_feature,
