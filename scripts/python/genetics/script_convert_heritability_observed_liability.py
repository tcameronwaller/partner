"""
Organize procedural code to test the conversion of SNP heritability from the
observed scale to the liability scale.

This module makes use of the 'utility' module within the 'partner' package.
