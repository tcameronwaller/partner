...
path_file_product=${2} # full path to product file to which to write in text format the identifiers or names of genes
delimiter_source=${3} # text delimiter between items in source file, not white space
delimiter_product=${4} # text delimiter between items in product file, not white space
type_source=${5} # type of identifiers or names of genes in source query
type_product=${6} # type of identifiers or names of genes in product delivery
species=${7} # name of species, either "human", "mouse", or another relevant option
