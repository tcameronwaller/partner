...
zcat $path_gwas_source | awk 'BEGIN { FS=" "; OFS=" " } NR > 1 {
  if ( NF != 7)
    ...
    print $1, $2, $3, $4, $5, $6, ( 1.0E-305 )
  else if ( ( $7 != "NA" ) && ( ($7 + 0) > 1.0 ) )
    # Constrain probability value.
    print $1, $2, $3, $4, $5, $6, ( 1.0 )
  else
    print $0
...
# sample size: ............................  "N" ..................  "None" ................... 500,199 (170,756 + 329,443)
...
cat $path_gwas_constraint | awk 'BEGIN { FS=" "; OFS=" " } NR > 1 {print $1, toupper($2), toupper($3), (170756 + 329443), exp($5), $7}' >> $path_gwas_format
