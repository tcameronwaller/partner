...
# file: "pgc_alcdep.eur_unrel_genotyped.aug2018_release.txt.gz"
...
# sample size: ............................  "N" ..................  None .................. (28,757 = 8,485 + 20,272)
# effect (coefficient or odds ratio): .....  "BETA" or "OR" .......  "OR" .................. 7
# probability (p-value): ..................  "P" ..................  "P" ................... 9

# Organize information from linear GWAS.
echo "SNP A1 A2 N OR P" > $path_gwas_format
cat $path_gwas_constraint | awk 'BEGIN { FS=" "; OFS=" " } NR > 1 {print $2, toupper($4), toupper($5), (8485 + 20272), $7, $9}' >> $path_gwas_format
