...
# "Organize any GWAS summary statistics in standard format for team."
...
# TODO: the plan here is to specify parameters that specify the awk columns for each
# TODO: column of interest
# TODO: then a call to awk with these parameters will adapt format to team standard

# TODO: Each GWAS summary statistics table needs a parameter to specify which
# TODO: source column maps to each of the product columns:
# TODO: "SNP CHR BP A1 A2 A1AF BETA SE P N Z INFO NCASE NCONT"

# TODO use...
# ... | awk -v awk_var=$bash_var `BEGIN {}`

# TODO:
# TODO: Keep this script SIMPLE!
# TODO: I don't think it's even necessary to include the CONSTRAINT block here.
# TODO: Use the constraint block in subsequent scripts that convert the GWAS sum stats
# TODO: FROM team standard format TO a format appropriate for LDSC or PRS-CS.
