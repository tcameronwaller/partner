...
# "Organize GWAS summary statistics in format for analysis by team."
...
path_directory_product_temporary="${path_directory_product}/temporary_zfgq3" # include unique (hopefully) string
