...
# Line for CAT AWK below: print $3, toupper($6), toupper($4), $12, $15
# Line for CAT AWK below: print $3, toupper($6), toupper($5), $12, $15
# Convert original 'odds ratio' to 'log odds' or 'coefficient'.
# Line for CAT AWK below: print $3, toupper($6), toupper($4), ( log($12) ), $15
# Line for CAT AWK below: print $3, toupper($6), toupper($5), ( log($12) ), $15
#echo "SNP A1 A2 N BETA P" > $path_gwas_format
cat $path_gwas_constraint | awk 'BEGIN { FS=" "; OFS=" " } NR > 1 {
  if ($6 == $5 && $6 != $4)
    print $3, toupper($6), toupper($4), ($12), $15
  else if ($6 == $4 && $6 != $5)
    print $3, toupper($6), toupper($5), ($12), $15
  else
    next
  }' >> $path_gwas_format
