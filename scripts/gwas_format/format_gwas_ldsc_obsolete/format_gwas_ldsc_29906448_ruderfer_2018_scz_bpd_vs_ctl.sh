...
# sample size: ............................  "N" ..................  None ..................  (20,129 + 33,426 + 54,065)
...
zcat $path_source_file | awk 'BEGIN { FS=" "; OFS=" " } NR > 1 {print $2, toupper($4), toupper($5), (20129 + 33426 + 54065), log($9), $11}' >> $path_gwas_collection
