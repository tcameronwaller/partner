...
# Count of cases: 29,529
# Count of controls: 166,007
# Count of total observations: 195,536
# Proportion of cases: 0.151
# Proportion of controls: 0.849
...
if [ "$fill_observations" != "1" ] && [ "$fill_case_control" != "1" ]; then
  zcat $path_file_source | awk 'BEGIN {FS = " "; OFS = " "} NR > 1 {
    if ((toupper($9) != "NA") && (($9 + 0) > 0))
      print $2, $1, $3, toupper($4), toupper($5), (($6*0.151)+($7*0.849)), log($9), $10, $11, ($17 + $18), "NA", $8, $17, $18
    else
      print $2, $1, $3, toupper($4), toupper($5), (($6*0.151)+($7*0.849)), "NA", $10, $11, ($17 + $18), "NA", $8, $17, $18
