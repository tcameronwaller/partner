...
# Count of cases: 53,386
# Count of controls: 77,258
# Proportion of cases: 0.409
# Proportion of controls: 0.591
...
if [ "$fill_observations" != "1" ] && [ "$fill_case_control" != "1" ]; then
  zcat $path_file_source | awk 'BEGIN {FS = " "; OFS = " "} NR > 74 {
    print $2, $1, $3, toupper($4), toupper($5), (($6*0.409)+($7*0.591)), $9, $10, $11, ($12 + $13), "NA", $8, $12, $13
