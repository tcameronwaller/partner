...
# Count of cases: 23,185
# Count of controls: 151,309
# Count of total observations: 174,494
# Proportion of cases: 0.133
# Proportion of controls: 0.867
...
if [ "$fill_observations" != "1" ] && [ "$fill_case_control" != "1" ]; then
  zcat $path_file_source | awk 'BEGIN {FS = " "; OFS = " "} NR > 1 {
    if ((toupper($9) != "NA") && (($9 + 0) > 0))
      print $2, $1, $3, toupper($4), toupper($5), (($6*0.133)+($7*0.867)), log($9), $10, $11, ($17 + $18), "NA", $8, $17, $18
    else
      print $2, $1, $3, toupper($4), toupper($5), (($6*0.133)+($7*0.867)), "NA", $10, $11, ($17 + $18), "NA", $8, $17, $18
