...
# Count of cases: 33,097
# Count of controls: 35,190
# Proportion of cases: 0.485
# Proportion of controls: 0.515
...
if [ "$fill_observations" != "1" ] && [ "$fill_case_control" != "1" ]; then
  zcat $path_file_source | awk 'BEGIN {FS = " "; OFS = " "} NR > 1 {
    if ((toupper($9) != "NA") && (($9 + 0) > 0))
      print $2, $1, $3, toupper($4), toupper($5), (($6*0.485)+($7*0.515)), log($9), $10, $11, ($17 + $18), "NA", $8, $17, $18
    else
      print $2, $1, $3, toupper($4), toupper($5), (($6*0.485)+($7*0.515)), "NA", $10, $11, ($17 + $18), "NA", $8, $17, $18
